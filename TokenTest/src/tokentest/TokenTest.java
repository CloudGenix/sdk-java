...
// To run:
// java -classpath "lib/*" -jar TokenTest.jar
// 
...
{ 
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        sdk = new CloudGenixSdk(token, true, true);
        ...
        while (runForever)
        {
            ...
            switch (cmd)
            {
                ...
                case "endpoint":
                    System.out.println("Current endpoint: " + sdk.endpoint);
                    System.out.print("New endpoint: ");
                ...
                case "login":
                    System.out.println(sdk.loginWithToken());
                    break;
    ...
    private static void menu()
    {
        ...
        System.out.println("  endpoint       set the CloudGenix controller endpoint");
        System.out.println("  login          login with authentication token");
